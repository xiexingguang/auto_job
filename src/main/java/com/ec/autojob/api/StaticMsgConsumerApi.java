 ...
 * @see 	 
 */
@Component(value="staticMsgConsumerServiceImp2")
public class StaticMsgConsumerApi  implements  StaticMsgService{
	...
	public <T> T handlerStaticData(String colletcionName, T t) {
	  ...
	  //平均每个企业发送的客服消息数
		...
		try{
		 ...
		 LOG.info("网站客服统计信息为==》"+JSONObject.toJSONString(bean));
		}catch(Exception e){
